# cyberpunkanimescsbv3.json

Dockerized ComfyUI workflow: CyberpunkAnimescsbv3.json
...
docker build -t cyberpunkanimescsbv3.json .

# Run the container
docker run -p 8188:8188 cyberpunkanimescsbv3.json
```
